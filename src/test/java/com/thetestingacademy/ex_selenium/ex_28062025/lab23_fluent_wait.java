...
import static com.thetestingacademy.ex_selenium.ex_28062025.WaitHelpers.checkVisibilityByFluentWait;

public class lab23_fluent_wait {
    @Test
...
//        });
        ...
        error_message = checkVisibilityByFluentWait(driver,By.className("notification-box-description"));
